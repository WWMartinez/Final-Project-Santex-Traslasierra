...
const { createInfoCard, getIdInfoCard, putInfoCard, deleteInfoCard } = require('./infoCard.controller');
...
module.exports = {
  ...
  infoCardController: { createInfoCard, getIdInfoCard, putInfoCard, deleteInfoCard },
};
