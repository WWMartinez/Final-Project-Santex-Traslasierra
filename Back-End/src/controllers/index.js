...
const { createInfoCard, getIdInfoCard, putInfoCard, deleteInfoCard, findInfoCards } = require('./infoCard.controller');
...
module.exports = {
  ...
  infoCardController: { createInfoCard, getIdInfoCard, putInfoCard, deleteInfoCard, findInfoCards },
};
